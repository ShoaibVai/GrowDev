...
<div :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}"
    ...
    <nav class="mt-5 px-4 space-y-2">
        ...
        <a href="{{ route('projects.index') }}"
           class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-150 {{ request()->routeIs('projects.*') && !request()->routeIs('projects.*.sprints.*') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('tasks.my-tasks') }}"
           class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-150 {{ request()->routeIs('tasks.my-tasks') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
