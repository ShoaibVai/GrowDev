...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
    ...
    <head>
        ...
        <style>
            ...
            .card { transform-origin: center; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
            ...
            .btn-glow:hover { box-shadow: 0 0 20px rgba(99, 102, 241, 0.5); }
            ...
            input.success { border-color: #10b981 !important; box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.1) !important; }
    ...
    <body class="h-full font-sans antialiased text-gray-900 dark:text-gray-100 dark:bg-gray-900">
        ...
        function themeManager() {
            return {
                ...
                init() {
                    this.preference = localStorage.getItem('theme-preference') || '{{ Auth::user()->theme ?? "system" }}';
                    this.applyTheme();
                ...
                save() {
                    fetch('/profile/theme', {
                        ...
                        body: JSON.stringify({ theme: this.preference }),
                    });
                },
            };
        }
